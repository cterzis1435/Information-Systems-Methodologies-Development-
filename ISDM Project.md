...
The CMC system project for the travel agency was approached with a design thinking mind frame. This approach involves understanding that the customers are central to the design of the system. In this case, we focused on thoroughly involving customers and eliciting their requirements to frame how to develop their new system. We ensured to empathise with customers and to immerse ourselves in their experiences, using techniques such as empathy maps, whilst resolving any pain points throughout the journey. In this way, we could gather requirements directly from users of the system and could hence develop a feasible and functional solution to satisfy their needs. This process was iterative and involved brainstorming ideas to generate rapid and innovative solutions. To further understand the problem, we reframed our perspective by gathering ‘point of view’ statements and developed ‘how might we’ statements. This enabled us to consider the customer when defining the system problem.
...
* Relationship Managers need a way to use their skills and product knowledge more effectively, because it would help create more sales.
...
End Customer:
* End customers need a way to communicate our needs in a simple manner with the travel agents to obtain the information we require 
...
* End Customers need a way to get assistance quickly, because we do not like to wait for long periods of time on a call.
...
* RMs have knowledge on all the travel packages being offered by the company.
...
* Customers can order the travel packages straight from the RM.
...
## Backlog Table
| User Story# | User Story                                                                                                                                                                                                                                | Estimation | Status      | Priority |
|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|-------------|----------|
